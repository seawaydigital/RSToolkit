...
Unperformed steps remain open. Any confusing or failed scenario returns to implementation before publication. No external reviewer or fixed waiting period is required.
